...
\\Nel caso applicativo del progetto svolto in questa tesi si è usato l'ultima iterazione YOLOv8, la più performante. In questo elaborato ci si è dedicati dapprima alle generalità e ai principi fondamentali su cui si basa il modello, quindi all'analisi dell'evoluzione di YOLO partendo dall'architettura della prima iterazione e successivamente analizzando le modifiche e le aggiunte fondamentali delle successive.
