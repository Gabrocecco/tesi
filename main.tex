...
\begin{abstract}
  \addcontentsline{toc}{chapter}{Abstract}
    ...
    Si è andati quindi a sviluppare una modello predittivo basato su alberi decisonali (Gradient Boosting) in grado di predire propietà chimico-fisiche a partire dalla conformazione strutturale e topologica dei campioni.
\end{abstract}
\end{otherlanguage}
