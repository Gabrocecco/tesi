...
\afterpage{\blankpage}
\newpage
\emph{Per mio padre Domenico e mia madre Sara, che fin dall'inizio, hanno sempre supportato e incoraggiato tutte le mie passioni, desideri e scelte.}
...
\begin{abstract}
  \addcontentsline{toc}{chapter}{Abstract}
    ...
    L'obbiettivo del progetto svolto è stato quello di mettere in correllazione le proprietà chimico-fisiche di campioni di grafene, provenienti da simulazioni al calcolatore, con
    ...
    Grazie a questi metodi è stato possibile andare ad analizzare automaticamente i difetti di ogni campione e cercare quindi eventuali correlazioni con le proprietà fisiche del campione stesso. 
    Si è andati quindi a sviluppare un modello predittivo basato su alberi decisonali (Gradient Boosting) in grado di predire proprietà chimico-fisiche a partire dalla conformazione strutturale e topologica dei campioni.
\end{abstract}
\end{otherlanguage}
...
\newpage
% \newpage % Puoi aggiungere una nuova pagina prima dei ringraziamenti
...
% {\fancyplain{}{\bfseries\thepage}}
\begingroup
\pagestyle{plain} % Cambia lo stile di pagina a plain temporaneamente
...
\newpage
\begin{thebibliography}{}             %crea l'ambiente bibliografia
...
\bibitem{K1} Bottou, Léon; Bousquet, Olivier (2007). \emph{The Tradeoffs of Large Scale Learning}
...
\bibitem{Forni} Tommaso Forni, Matteo Baldoni, Francesco Mercuri, \emph{GrapheNet: A Novel Deep Learning Model for Predicting Physical and
...
% Ringrazio il mio relatore Paolo Bellavista per la grande disponibilità, i consigli per la stesura della tesi ma soprattutto per l'interesse dimostrato per il lavoro svolto.
% Ringrazio il mio supervisore di tirocinio Francesco Mercuri presso CNR-ISMN e a tutti i colleghi del gruppo di ricerca che mi hanno accolto, stimolato e aiutato tantissimo durante il mio lavoro. Grazie a queste persone l'esperienza è stata incredibilmente significativa sia dal punto di vista professionale che umano.
% Grazie ai parenti e amici che mi hanno supportato durante questi anni di studio.
